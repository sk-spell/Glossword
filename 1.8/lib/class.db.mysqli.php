...
if ( ! class_exists('gwtkDataBase')) {
    ...
    class gwtkDataBase
    {
         ...
         */
        public function prepare_execute($query, $params = array(), $types = '')
        {
            if (!$this->connect()) {
                return false;
            }
         ...
         * @return array|bool Query result or false on failure
         */
        public function sqlExecSafe($query, $params = array())
        {
            if (empty($params)) {
                return $this->sqlExec($query);
            }
            
            // Convert named placeholders to ? placeholders
            ...
            // Build indexed parameter array in correct order
